...
public class Jail { //separate from Visiting ru.vsu.cs.sviridov_d_v.Jail square on board
    private Game game;
    ...
    public void sendToJail(Player jailedPlayer) {
        ...
        System.out.println("You are now in ru.vsu.cs.sviridov_d_v.Jail for the next 3 turns");
