...
public class Player {
    ...
    //add property to ru.vsu.cs.sviridov_d_v.Player's properties
    ...
    //returns list of all properties that ru.vsu.cs.sviridov_d_v.Player owns color group
    ...
    //return list of all properties that ru.vsu.cs.sviridov_d_v.Player can place house
    ...
    //check if property is in ru.vsu.cs.sviridov_d_v.Player's properties
    private boolean owns(Property property) {
        return properties.contains(property);
    }

    //check if ru.vsu.cs.sviridov_d_v.Player owns all of a certain color group
