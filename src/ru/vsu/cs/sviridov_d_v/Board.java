...
public class Board {
    ...
    private Square createSquare(int position) {
        switch (position) {
            ...
            case 5:
                return new Railroad("Reading ru.vsu.cs.sviridov_d_v.Railroad");
            case 6:
            ...
            case 10:
                return new Square("Just Visiting ru.vsu.cs.sviridov_d_v.Jail");
            case 11:
            ...
            case 15:
                return new Railroad("Pennsylvania ru.vsu.cs.sviridov_d_v.Railroad");
            case 16:
            ...
            case 25:
                return new Railroad("B&O ru.vsu.cs.sviridov_d_v.Railroad");
            case 26:
            ...
            case 30:
                return new Square("Go to ru.vsu.cs.sviridov_d_v.Jail") {
                    @Override
    ...
    private Card createCommunityChestCard(int index) {
        switch (index) {
            ...
            case 5:
                return new CollectCard(20, "Income ru.vsu.cs.sviridov_d_v.Tax Refund");
            case 6:
            ...
            case 12:
                return new CollectCard(-150, "School ru.vsu.cs.sviridov_d_v.Tax");
            case 13:
    ...
    private Card createChanceCard(int index) {
        switch (index) {
            ...
            case 4:
                return new MoveToCard(new int[]{5}, this, "Take a ride on the Reading ru.vsu.cs.sviridov_d_v.Railroad");
            case 5:
            case 6:
                return new MoveToCard(new int[]{5, 15, 25, 35}, this, "Advance to nearest ru.vsu.cs.sviridov_d_v.Railroad");
            case 7:
                return new MoveToCard(new int[]{12, 28}, this, "Advance to nearest ru.vsu.cs.sviridov_d_v.Utility");
            case 8:
            ...
            case 11:
                return new CollectCard(-15, "Poor ru.vsu.cs.sviridov_d_v.Tax");
            case 12:
                return new CollectEveryCard(players, 50, "You Have Been Elected Chairman of the ru.vsu.cs.sviridov_d_v.Board");
            case 13:
                return new HouseRepairCard(25, 100, "Make General Repairs on your ru.vsu.cs.sviridov_d_v.Property");
            case 14:
                return new ToJailCard(jail);
            case 15:
                return new OutOfJailCard();
